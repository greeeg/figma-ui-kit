import React, { ChangeEvent, ClipboardEvent, FocusEvent, KeyboardEvent, MouseEvent, ReactNode, useCallback, useRef, useState } from 'react'
...
export function TextboxAutocomplete<Name extends string>({
  ...
  const handlePaste = useCallback(
    function (event: ClipboardEvent<HTMLInputElement>): void {
      if (strict === false) {
        return
      }
